...
export default function DateNavigator() {
  const { selectedDate, setSelectedDate, dailyData, zoomedDate, setZoomedDate } = useAppStore();
    ...
    <div className="bg-white/80 backdrop-blur-sm card-shadow rounded-xl p-4 mb-6 animate-fade-in">
      ...
      <div className="flex flex-wrap gap-2">
        {DATES.map((date, index) => {
          ...
          const hasWarning = dayData ? isDateWarning(dayData) : false;
            ...
            <button
              ...
              className={`
                ...
                ${isSelected
                  ...
                  : hasWarning
                  ? 'bg-warning-50 text-warning-700 border border-warning-300 hover:bg-warning-100 hover:scale-105'
                  : 'bg-primary-50 text-primary-700 border border-primary-200 hover:bg-primary-100 hover:scale-105'
                }
              `}
              style={{
